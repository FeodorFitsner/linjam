...
const String     GUI::MASTER_CHANNELS_GUI_ID     = "Master" ;
const Identifier GUI::MASTER_CHANNELS_IDENTIFIER = MASTER_CHANNELS_GUI_ID ;
const String     GUI::LOCAL_CHANNELS_GUI_ID      = "Local" ;
const Identifier GUI::LOCAL_CHANNELS_IDENTIFIER  = LOCAL_CHANNELS_GUI_ID ;
*/
// MixerGroup
...
const String     GUI::REMOTES_MIXERGROUP_GUI_ID     = "Remotes" ;
const Identifier GUI::REMOTES_MIXERGROUP_IDENTIFIER = REMOTES_MIXERGROUP_GUI_ID ;
